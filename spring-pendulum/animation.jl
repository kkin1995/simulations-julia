...
using .SpringPendulumSimulation
using Plots

initialAngle = 10
initialExtension = 1
l0 = 1
time, x, vx, θ, ω = SpringPendulum(initialAngle, initialExtension, l0 = l0, k = 2)
...
@time for i = 1:no_of_steps-1
    plot([0, xs[i]], [0, ys[i]], xlim = (-20, 20), ylim = (-20, 20),
...
gif(anim, "spring_pendulum_animation.gif", fps = 120)